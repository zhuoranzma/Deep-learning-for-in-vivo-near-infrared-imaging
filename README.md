...
(6) Install PyTorch (https://pytorch.org/) by running a command. 
...
```
Images to be traslated should be stored in the datasets/NIRI_to_NIRII/val/A directory. You can also run the conde on a cpu by removing the '--cuda' flag. Images generated by the neural network will be saved in the generated_image directory. IWe give some examples of our results in the results directory.   
