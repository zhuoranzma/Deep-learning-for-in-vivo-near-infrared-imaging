...
```
Images to be traslated should be stored in the datasets/NIRI_to_NIRII/val/A directory. Images generated by the neural network will be saved in the generated_image directory. We provide pre-trained weights of the U-Net generators and PatchGAN discriminators in the model directory.
